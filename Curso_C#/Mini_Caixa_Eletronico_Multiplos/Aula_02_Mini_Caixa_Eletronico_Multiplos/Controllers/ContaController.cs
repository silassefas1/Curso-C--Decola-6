using Aula_02_Mini_Caixa_Eletronico_Multiplos.Data;
using Aula_02_Mini_Caixa_Eletronico_Multiplos.Models;
using Aula_02_Mini_Caixa_Eletronico_Multiplos.Views;

namespace Aula_02_Mini_Caixa_Eletronico_Multiplos.Controllers
{
    public class ContaController
    {
        ...
        public void Iniciar()
        {
            ...
            while (true)
            {
                ...
                Conta contaLogada = _repositorio.BuscarContaPorNumero(numeroConta);
                if (contaLogada != null)
                {
