...
namespace AulaEntity.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(AulaEntityContext context)
        {
            _context = context;
        }
        ...
        {
            var aulaEntityContext = _context.Student.Include(s => s.Grade);
            return View(await aulaEntityContext.ToListAsync());
        }
